...
Note that you will need hydrangea:fixtures_mods_article1 later in this tour, so if you delete it, you will need to re-create it.
...
copy_as_specialthing.datastreams["properties"].class
...
Now read the "NOKOGIRI_DATASTREAMS.textile":https://github.com/mediashelf/active_fedora/blob/master/NOKOGIRI_DATASTREAMS.textile to see what the datastream definitions have done for you.
