module ActiveFedora
  module FedoraAttributes
    ...
    included do
      attribute :has_model, [ RDF::URI.new("info:fedora/fedora-system:def/relations-external#hasModel"), FedoraLens::Lenses.single, FedoraLens::Lenses.literal_to_string ]
