...
describe ActiveFedora::Base do
  ...
  it "should push all of the metadata fields into solr" do
    ...
    @properties_sample_values.each_pair do |field, value|
      ...
      expect(@solr_result[ActiveFedora::SolrService.solr_name(field, :string, :searchable)] || @solr_result[ActiveFedora::SolrService.solr_name(field, :date)]).to eq([::Solrizer::Extractor.format_node_value(value)])
    end
