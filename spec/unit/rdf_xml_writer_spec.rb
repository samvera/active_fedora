...
describe ActiveFedora::RDFXMLWriter do
  before(:all) do
    @rdf_xml = <<-EOS
      <rdf:RDF xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>
        <rdf:Description rdf:about='info:fedora/test:sample_pid'>
          <isMemberOf rdf:resource='info:fedora/demo:10' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
          <isPartOf rdf:resource='info:fedora/demo:11' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
          <hasPart rdf:resource='info:fedora/demo:12' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
          <hasModel rdf:resource='info:fedora/afmodel:OtherModel' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
          <hasModel rdf:resource='info:fedora/afmodel:SampleModel' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
        </rdf:Description>
      </rdf:RDF>
    EOS
    ...
    @rdf_xml_with_type = <<-EOS
      <rdf:RDF xmlns:rdf='http://www.w3.org/1999/02/22-rdf-syntax-ns#'>
        <rdf:Description rdf:about='info:fedora/test:sample_pid'>
        <isMemberOf rdf:resource='demo:10' xmlns='http://fedora.info/definitions/v4/rels-ext#'/>
  ...
  it 'should serialize graphs without rdf:type equivalently to RDF::RDFXML::Writer' do
    ...
    graph.insert RDF::Statement.new(subject, ActiveFedora::Predicates.find_graph_predicate(:has_model),  RDF::URI.new("http://fedora.info/definitions/v4/model#OtherModel"))
    graph.insert RDF::Statement.new(subject, ActiveFedora::Predicates.find_graph_predicate(:has_model),  RDF::URI.new("http://fedora.info/definitions/v4/model#SampleModel"))
