...
describe ActiveFedora::Base do
  ...
  describe '.add_datastream' do
    it "should not call Datastream.save" do
      ds = ActiveFedora::Datastream.new(@test_object, 'ds_to_add')
    ...
    it "should auto-assign dsids using auto-incremented integers if dsid is nil or an empty string" do 
      ds = ActiveFedora::Datastream.new(@test_object, nil)
      ds.dsid.should == 'DS1'
      @test_object.add_datastream(ds).should == 'DS1'
      ds_emptystringid = ActiveFedora::Datastream.new(@test_object, '')
    ...
    it "should accept a prefix option and apply it to automatically assigned dsids" do
      ds = ActiveFedora::Datastream.new(@test_object, nil, :prefix=> "FOO")
      ds.dsid.should == 'FOO1'
    end
  end
end
