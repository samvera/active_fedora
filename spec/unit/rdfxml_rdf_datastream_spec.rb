...
describe ActiveFedora::RdfxmlRDFDatastream do
  ...
  describe "a complex data model" do
    ...
    describe "a new instance" do
      subject { MyDatastream.new(double('parent object', :uri=>'/fedora/rest/test/123', :new_record? =>true), 'descMetadata', about:"http://library.ucsd.edu/ark:/20775/") }
    ...
    describe "an instance with content" do
      let(:parent) { double('parent object', uri: '/fedora/rest/test/234', id: 'foo',  new_record?: true) }
      subject do
